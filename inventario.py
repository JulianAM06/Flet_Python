...
def main (page: ft.Page):
    ...
    producto = ft.TextField(hint_text="Producto", width=300)
    cantidad = ft.TextField(hint_text="Cantidad", width=300)
    precio = ft.TextField(hint_text="Precio", width=300)
    ...
    actualizarProducto = ft.ElevatedButton(text='Actualizar Producto', col={"sm": 3}, bgcolor=ft.colors.BLUE, color=ft.colors.BLACK, on_click=crearProducto1)
    buscarProducto = ft.ElevatedButton(text='Buscar Producto', col={"sm": 3}, bgcolor=ft.colors.GREEN, color=ft.colors.BLACK, on_click=crearProducto1)
